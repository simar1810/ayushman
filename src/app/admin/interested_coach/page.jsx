...
import { isAuth, getCookie, getIntrestedCoaches } from "@/actions/auth";
...
const IntrestedAppCoaches = () => {
  ...
  const fetchData = async () => {
    try {
      const data = await getIntrestedCoaches(currentPage, debouncedSearchQuery, token);
  ...
  return (
    <AdminDashboard>
      ...
      <div className="text-center text-sm mb-3">
        Intrested AppCoaches &nbsp;-&nbsp; {userscount}
      </div>
...
export default IntrestedAppCoaches;
